'''
    ...
    Based on: 'Going deeper with convolutions' paper
...
class SideNet(cnn.CNN):
  ...
  def __init__(self, prev_layer):
    self.model = prev_layer
    #TODO: write side net from googlenet using () style
...
class Inception(cnn.CNN):
  ...
  def __init__(self, prev_layer, nbf_conv_a=[64], nbf_conv_b=[96,128], nbf_conv_c=[16,32], nbf_pooling=[32]):
    Inception.idx += 1
    self.model = prev_layer
    #TODO: write inception net from googlenet using () style
